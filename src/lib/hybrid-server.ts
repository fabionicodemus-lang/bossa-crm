...
export async function applyHybridDecision(args: {
  ...
  if (decision.handoffRequired && args.lead.owner_mode !== 'human') {
    ...
    const handoffBriefing = {
      ...
      city_country: args.turn.extracted.region,
      payment_method: args.turn.extracted.payment_method,
      preferred_contact_time_local: args.turn.extracted.preferred_contact_time_local,
      preferred_contact_time_brasilia: args.turn.extracted.preferred_contact_time_brasilia,
